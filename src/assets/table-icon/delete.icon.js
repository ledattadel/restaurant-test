...
const DeleteIcon = ({ onClick }) => {
    const [colorBg, setColorBg] = React.useState('#DC0000');
    ...
    return (
        ...
        >
            <path d="M3 6H5H21" fill={colorBg} />
            <path d="M3 6H5H21" stroke={colorBg} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path
